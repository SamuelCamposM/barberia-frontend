...
export const useCitaStore = () => {
  ...
  const setItemActive = async (
    ...
    // Si el cita está cambiando de tab, actualiza el item estado
    if (isEditingToDefault) {
      const result = await Swal.fire({
        title: `Estás editando un cita`,
    ...
    // Si el cita está en el estado por defecto, no hace nada
