...
import { CategoriaItem } from "..";
import { SocketEmitCategoria } from "../helpers";
...
export const EditableCategoria = ({
  ...
  return (
    <StyledTableRow key={categoria._id} crud={categoria.crud}>
